...
AddEventHandler('CBCore:Server:PlayerLoaded', function(qbPlayer)
  local playerIdent = cbPlayer.PlayerData.citizenid
  local phoneNumber = tostring(qbPlayer.PlayerData.charinfo.phone)
  local charInfo = cbPlayer.PlayerData.charinfo
  local playerSrc = cbPlayer.PlayerData.source
...
RegisterNetEvent("cb-npwd:server:UnloadPlayer", function()
  local src = source
...
AddEventHandler('onServerResourceStart', function(resName)
  ...
  local players = CBCore.Functions.GetQBPlayers()
...
CBCore.Functions.CreateUseableItem(getTableKeys(Config.PhoneList), function(source, item)
  TriggerClientEvent('cb-npwd:client:setPhoneVisible', source, true)
end)